<div align="center">
  ...
  <p><a href="README.md">中文</a> · <a href="https://aifast.apifox.cn/">API docs</a> · <a href="https://docs.aifast.club/start/?utm_source=github&utm_medium=repository&utm_campaign=developer-acquisition&utm_content=api-status-hero-start-en">Start by task</a> · <a href="https://docs.aifast.club/model-check/">Online model check</a></p>
</div>
...
| Choose a first-call, migration or enterprise workflow | [Start by task](https://docs.aifast.club/start/?utm_source=github&utm_medium=repository&utm_campaign=developer-acquisition&utm_content=api-status-bottom-start-en) |
