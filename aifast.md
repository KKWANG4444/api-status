...
1. [注册 AI快站账号](https://www.aifast.club/register?utm_source=github&utm_medium=pages&utm_campaign=integration-guide&utm_content=aifast-workflow-register)，进入控制台创建 API Key；
...
- [注册使用](https://www.aifast.club/register?utm_source=github&utm_medium=pages&utm_campaign=integration-guide&utm_content=aifast-resources-register)
