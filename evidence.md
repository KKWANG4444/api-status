...
新站统一使用美元（USD）充值并按 1:1 计入账户余额：**⭐️ 1 AIFast Credit = US$1**。支付方式、折扣、支付网络、通道费用和最终到账属于动态信息，以控制台与结账页当前显示为准。
...
| USD 充值与账户结算 | [公开状态配置](https://www.aifast.hk/api/status) | 支付方式、折扣、通道和最终到账以控制台与结账页为准 |
