...
- **API Key**：在控制台创建的令牌
- **Model ID**：从模型广场复制，注意点号和连字符；GPT-6 Sol 和 GPT-6 Luna 的当前 ID 分别为 `gpt-6-sol` 和 `gpt-6-luna`
...
4. 添加模型广场中的精确 ID，例如 `gpt-6-sol`、`gpt-6-luna`、`claude-opus-5-5` 或 `deepseek-v4-pro`。
5. 发起短对话验证。
