---
layout: default
title: AI模型接入指南 | OpenAI SDK、Cursor、Dify与Claude Code
description: 使用 OpenAI-compatible 接口配置 Base URL、API Key 和精确模型 ID，并完成 Cursor、Dify 与 Claude Code 的最小调用验证。
permalink: /guide/
---
